...
if ( ! class_exists( 'RWMB_Plupload_Image_Field' ) )
{
	class RWMB_Plupload_Image_Field extends RWMB_Image_Field
	{
		...
		static function html( $html, $meta, $field )
		{
			...
			$i18n_drop   = apply_filters( 'rwmb_plupload_image_drop_string', _x( '将图像拖到这里', 'image upload', 'rwmb' ), $field );
			$i18n_or     = apply_filters( 'rwmb_plupload_image_or_string', _x( '或', 'image upload', 'rwmb' ), $field );
			$i18n_select = apply_filters( 'rwmb_plupload_image_select_string', _x( '选择文件', 'image upload', 'rwmb' ), $field );
