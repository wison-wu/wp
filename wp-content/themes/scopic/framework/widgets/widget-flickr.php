...
add_action( 'widgets_init', 'ht_flickr_widgets' );

// Register widget
function ht_flickr_widgets() {
	register_widget( 'ht_flickr_widget' );
}

// Widget class
class ht_flickr_widget extends WP_Widget {
...
function ht_flickr_widget() {

	// Widget settings
	$widget_ops = array(
		'classname' => 'ht_flickr_widget',
		'description' => __('A widget that displays your Flickr photos.', 'framework')
	);

	/* Widget control settings. */
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'ht_flickr_widget' );

	// Create the widget
	$this->WP_Widget( 'ht_flickr_widget', __('Custom Flickr Photos', 'framework'), $widget_ops, $control_ops );
