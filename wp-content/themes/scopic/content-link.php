...
$ht_post_title = get_post_meta( get_the_ID(), '_ht_pf_link_post_title', true ); 
$ht_post_excerpt = get_post_meta( get_the_ID(), '_ht_pf_link_post_excerpt', true );
?>
