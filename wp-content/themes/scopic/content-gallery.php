...
$ht_post_title = get_post_meta( get_the_ID(), '_ht_pf_gallery_post_title', true ); 
$ht_post_excerpt = get_post_meta( get_the_ID(), '_ht_pf_gallery_post_excerpt', true );
?>
